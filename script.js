...
// --- VERSION 1: Minimalist (Color-Locked by Pitch) ---
// En cada nota, obligamos a que el lienzo cambie a un color fijo basado en la nota.
// Nota C (0) -> Rojo, D (2) -> Naranja...

function updateCanvasColor(midiNote) {
    const hue = (midiNote % 12) * 30; // 0, 30, 60...
    document.body.style.backgroundColor = `hsl(${hue}, 70%, 20%)`;
}

// In playSynth:
// updateCanvasColor(note);
